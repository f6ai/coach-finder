<template>
    ...
    <form @submit.prevent="submitForm">
        ...
        <div class="form-control" :class="{ invalid: !description.isValid }">
            ...
            <input type="textarea" rows="5" id="description" v-model.trim="description.val"
        ...
        <div class="form-control" :class="{ invalid: !rate.isValid }">
            ...
            <p v-if="!rate.isValid">Rate must not be 0 or negative.</p>
        </div>
        ...
        <p v-if="!formIsValid">The form is not valid. Please fix the error(s).</p>
